...
![pic: ABC15](/sdc/sdc-uber-crash.png){width=100%}
...
> **Update 3/27/2018** It is now clear, [after several news reports](https://jalopnik.com/lidar-maker-velodyne-blame-to-uber-in-fatal-self-drivin-1824027977), that Lidar(s) did not "see" the pedestrian. I am keeping this post as is (mostly), and will update with my thoughts on both this unfortunate incident and failure in general. 
...
![Traffic Stats](/sdc/sdc-traffic-stats.png){width=640}
...
![Pedestrian Fatalities](/sdc/traffic-ped-stat1.png){width=640}
...
![Fatality Trends, NHTSA](/sdc/traffic-fatality.png){width=640}
...
<img src="https://techcrunch.com/wp-content/uploads/2018/03/uber-atg-volvo.jpg" width=700 />
...
### References
1. [Uber self-driving car accident](https://www.reuters.com/article/us-autos-selfdriving-uber/self-driving-uber-car-kills-arizona-woman-crossing-street-idUSKBN1GV296)
2. [Tempe police chief says early probe shows no fault by Uber](https://www.sfchronicle.com/business/article/Exclusive-Tempe-police-chief-says-early-probe-12765481.php)
...
7. [NHTSA - USDOT Releases 2016 Fatal Traffic Crash Data](https://www.nhtsa.gov/press-releases/usdot-releases-2016-fatal-traffic-crash-data)
